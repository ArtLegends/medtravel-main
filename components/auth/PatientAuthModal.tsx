// components/auth/PatientAuthModal.tsx
"use client";
...
export default function PatientAuthModal({ open, onClose }: Props) {
  ...
  const callback = `${origin}/auth/callback?as=PATIENT&next=${encodeURIComponent(
    next,
  )}`;
