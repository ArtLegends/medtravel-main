...
const FINANCE_SUBMENU = [
  { title: "Balance breakdown", href: "/partner/finance/balance-breakdown" },
  { title: "Payouts history", href: "/partner/finance/payouts-history" },
  { title: "Payout method", href: "/partner/finance/payout-method" },
];
      ...
      <div className="mx-auto flex w-full max-w-[1920px]">
        ...
        >
          <div className="flex items-center justify-between border-b px-4 py-3">
            <span className="font-semibold text-gray-900">Partner Panel</span>
            <button
              onClick={() => setDrawerOpen(false)}
        ...
        <div className="flex min-h-screen flex-1 flex-col min-w-0">
          ...
          <header className="flex items-center border-b bg-white px-4 py-3 lg:hidden">
            ...
            <span className="ml-3 font-semibold text-gray-900">Partner Panel</span>
          </header>
